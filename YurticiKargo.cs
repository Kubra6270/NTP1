   ...
   public class YurticiKargo :Gonderi
    {
        ...
        public YurticiKargo(string gonderenAd, string gonderenAdres, string aliciAd, string aliciAdres, double agirlik, string il, string ilce)
        ...
        {
            return Agirlik * 20; // Yurtiçi kg başına 20TL olsun
        }
